...
public final class PlayerOfferingDataNotifyOuterClass {
  ...
  public interface PlayerOfferingDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PlayerOfferingData offering_data_list = 10;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OFFERING_DATA_LIST_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < offeringDataList_.size(); i++) {
        output.writeMessage(10, offeringDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < offeringDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, offeringDataList_.get(i));
      }
