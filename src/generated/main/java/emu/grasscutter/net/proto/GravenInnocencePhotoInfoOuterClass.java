...
public final class GravenInnocencePhotoInfoOuterClass {
  ...
  public interface GravenInnocencePhotoInfoOrBuilder extends
    ...
    /**
     * <code>repeated .GravenInnocencePhotoObjectInfo object_info_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OBJECT_INFO_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < objectInfoList_.size(); i++) {
        output.writeMessage(6, objectInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < objectInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, objectInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ect_info_list\030\006 \003(\0132\037.GravenInnocencePho" +
