...
public final class AttackHitEffectResultOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (java.lang.Float.floatToRawIntBits(hFHKMEOPFBI_) != 0) {
        output.writeFloat(5, hFHKMEOPFBI_);
      }
      if (eCBDDJLPPMK_ != 0) {
        output.writeUInt32(6, eCBDDJLPPMK_);
      }
      if (java.lang.Float.floatToRawIntBits(dADJPJBELMO_) != 0) {
        output.writeFloat(8, dADJPJBELMO_);
      }
      if (java.lang.Float.floatToRawIntBits(hDJALIDKDPN_) != 0) {
        output.writeFloat(10, hDJALIDKDPN_);
      }
      if (java.lang.Float.floatToRawIntBits(cCLCOGCLHKO_) != 0) {
